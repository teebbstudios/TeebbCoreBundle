...
{
    public const USER_ENTITY_TYPE_INDEX_FIELDS = 'user_entity_type_index_fields';
    public const USER_ENTITY_TYPE_ADD_FIELD = 'user_entity_type_add_field';
    public const USER_ENTITY_TYPE_UPDATE_FIELD = 'user_entity_type_update_field';
    public const USER_ENTITY_TYPE_DELETE_FIELD = 'user_entity_type_delete_field';
    public const USER_ENTITY_TYPE_DISPLAY_FIELDS = 'user_entity_type_display_fields';
    ...
    {
        return [
            'teebb.core.voter.user_entity_type_index_fields' => self::USER_ENTITY_TYPE_INDEX_FIELDS,
            ...
            'teebb.core.voter.user_entity_type_display_fields' => self::USER_ENTITY_TYPE_DISPLAY_FIELDS,
