        ...
        $rootNode
            ->children()
                ...
                ->arrayNode('from_email')
                    ->info('Must configure mail sending address and sender name.')
                    ->isRequired()
                    ->children()
                        ->scalarNode('address')->cannotBeEmpty()->isRequired()->end()
                        ->scalarNode('address_name')->cannotBeEmpty()->isRequired()->end()
                    ->end()
                ->end()
                ->arrayNode('cache')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->integerNode('expire_after')->defaultValue(86400)->info('Cache will expire after 86400 seconds(24hours).')->end()
                    ->end()
                ->end()
                    ...
                    ->children()
                        ...
                        ->addDefaultsIfNotSet()
                            ->children()
                                ...
                                ->scalarNode('list_type_contents')->defaultValue('@TeebbCore/front/list_type_contents.html.twig')->cannotBeEmpty()->end()
                                ->scalarNode('list_taxonomy_contents')->defaultValue('@TeebbCore/front/list_taxonomy_contents.html.twig')->cannotBeEmpty()->end()
                            ->end()
                        ->end()
                        ->arrayNode('content')
                        ->addDefaultsIfNotSet()
