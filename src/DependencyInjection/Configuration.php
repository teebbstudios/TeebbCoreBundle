            ...
            ->children()
                ...
                ->addDefaultsIfNotSet()
                    ->children()
                        ...
                        ->scalarNode('base_list')->defaultValue('@TeebbCore/CRUD/base_list.html.twig')->cannotBeEmpty()->end()
                        ->arrayNode('types')
                        ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('list')->defaultValue('@TeebbCore/types/list.html.twig')->cannotBeEmpty()->end()
                            ->end()
                        ->end()
                    ->end()
            ->end();
